                                    ...
                                    item.info.map((item2, index2) => {
                                        return (
                                            <Tr key={index2}>
                                                ...
                                                <Td textAlign={'center'} color={'var(--color-primer)'}>{item2.nama_alat}</Td>
                                                <Td display={'flex'} justifyContent='center' alignItems={'center'} ><Image height={'30px'} src={item2.icon} alt="icon" /></Td>
                                                <Td textAlign={'center'} color={'var(--color-primer)'}>{item2.life_cycle}</Td>
                                                <Td textAlign={'center'} color={'var(--color-primer)'}>{item2.warna} </Td>
                                                <Td textAlign={'center'}>
